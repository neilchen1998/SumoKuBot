...
The folllowing table shows the most recent version of MRV method versus the tradition method (the very first iteration). That's a whopping 120x improvement.

|               ms/op |                op/s |    err% |     total | Sumoku Solver Comparison #1
|--------------------:|--------------------:|--------:|----------:|:----------------------------
|              152.74 |                6.55 |    0.9% |      1.70 | `traditional`
|                0.14 |            6,920.13 |    1.3% |      0.01 | `MRV`

|               ms/op |                op/s |    err% |     total | Sumoku Solver Comparison #2
|--------------------:|--------------------:|--------:|----------:|:----------------------------
|               18.57 |               53.84 |    0.2% |      0.21 | `traditional`
|                0.15 |            6,810.44 |    1.9% |      0.01 | `MRV`

Note: The above results are generated by building it on a Mac Mini with M4 chip with 24 GB of RAM.
